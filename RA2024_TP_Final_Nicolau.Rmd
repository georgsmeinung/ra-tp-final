...
```{r plot_correlation_pearson_upper_quadrant, echo=FALSE, fig.width=6, fig.height=6, dpi=150}
...
```{r plot_correlation_pearson_cross, echo=FALSE, fig.width=6, fig.height=6, dpi=150}
...
```{r plot_correlation_pearson_lower_quadrant, echo=FALSE, fig.width=6, fig.height=6, dpi=150}
