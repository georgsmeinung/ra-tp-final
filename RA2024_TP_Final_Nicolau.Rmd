...
# Eliminar de la columan Description el prefijo de la variable
...
```{r univar_reg_pl_rvamp_qq_plot, warning=FALSE}
...
```{r univar_reg_st_rad_plot, warning=FALSE}
...
```{r univar_reg_st_rad_res_plot, warning=FALSE}
...
```{r univar_reg_st_rad_qq_plot, warning=FALSE}
...
```{r univar_reg_st_rad_shapiro_test}
